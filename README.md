...
This is the origin Pytorch implementation of DRECT in the following paper: [Fast and High-Resolution Reconstruction for Laplace NMR based on Deep Learning](https://pubs.acs.org/doi/10.1021/acs.analchem.3c00537). 
